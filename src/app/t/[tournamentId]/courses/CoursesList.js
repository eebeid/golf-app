            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
                ...
                {courses.map((course, index) => (
                    <div key={course.id} className="glass-panel" style={{
                        ...
                        {course.isMissing ? (
                            <div style={{ flex: 1, borderLeft: '4px solid #ef4444', paddingLeft: '1rem' }}>
                                ...
                                {course.rounds && course.rounds.length > 0 && (
                                    <div style={{ marginBottom: '1.5rem', color: '#ef4444', fontWeight: 'bold' }}>
                                        Round {course.rounds.join(', ')}
                                ...
                                <p style={{ color: 'var(--text-muted)' }}>
                                    The course assigned to this round could not be found. It may have been deleted from the tournament. Please go to Settings to assign a valid course for this round.
                                </p>
                            </div>
                        ) : (
                            <>
